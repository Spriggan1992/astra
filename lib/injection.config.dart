...
import 'domain/favorites/i_favorites_repository.dart' as _i19;
import 'domain/image_picker/i_image_picker.dart' as _i65;
...
import 'infrastructure/core/services/images/i_cache_image_service.dart' as _i9;
...
import 'infrastructure/core/services/user_online_status_service/user_online_status_service.dart'
    as _i70;
import 'infrastructure/favorites/favorites_repository.dart' as _i20;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i57.ChatBloc>(() => _i57.ChatBloc(
  ...
  gh.lazySingleton<_i59.DioInterceptor>(
      () => _i59.DioInterceptor(get<_i7.Dio>(), get<_i56.Authenticator>()));
  ...
  gh.factory<_i61.FavoriteBloc>(() => _i61.FavoriteBloc(
      get<_i19.IFavoritesRepository>(), get<_i11.ICacheUserService>()));
  ...
  gh.lazySingleton<_i69.IUserOnlineStatusService>(
      () => _i70.UserOnlineStatusService(get<_i56.Authenticator>()));
