...
import '../../../domain/image_picker/models/image.dart' as _i23;
...
import '../enums/store_screen_qualifier.dart' as _i26;
...
class StoreScreenRoute extends _i11.PageRouteInfo<StoreScreenRouteArgs> {
  StoreScreenRoute(
      {_i22.Key? key,
      _i26.StoreScreenQualifier storeQualifer =
          _i26.StoreScreenQualifier.storeSettings})
...
class StoreScreenRouteArgs {
  const StoreScreenRouteArgs(
      {this.key, this.storeQualifer = _i26.StoreScreenQualifier.storeSettings});

  final _i22.Key? key;

  final _i26.StoreScreenQualifier storeQualifer;
