...
import '../../../domain/chats/chats_model.dart' as _i28;
import '../../../domain/core/models/image_models.dart' as _i26;
import '../../../domain/profile/models/profile.dart' as _i27;
import '../../astra/chats/chat_screen/chat_screen.dart' as _i11;
import '../../astra/chats/chats_screen/chats_screen.dart' as _i18;
...
import '../enums/store_screen_qualifier.dart' as _i29;
...
class AppRouter extends _i13.RootStackRouter {
  ...
  final Map<String, _i13.PageFactory> pagesMap = {
    ...
    ChatScreenRoute.name: (routeData) {
      ...
      return _i13.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i11.ChatScreen(key: args.key, chatModel: args.chatModel));
    },
    ...
    ChatsScreenRoute.name: (routeData) {
      return _i13.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i18.ChatsScreen());
    },
  ...
  List<_i13.RouteConfig> get routes => [
        ...
        _i13.RouteConfig(ChatScreenRoute.name, path: '/chat-screen'),
        _i13.RouteConfig(HomeScreenRoute.name, path: '', children: [
          ...
          _i13.RouteConfig(ChatsRouter.name,
              path: 'chats',
              parent: HomeScreenRoute.name,
              children: [
                _i13.RouteConfig(ChatsScreenRoute.name,
                    path: '', parent: ChatsRouter.name)
              ]),
...
class SplashScreenRoute extends _i13.PageRouteInfo<SplashScreenRouteArgs> {
  SplashScreenRoute({_i25.Key? key, bool isLoading = false})
...
class ChatScreenRoute extends _i13.PageRouteInfo<ChatScreenRouteArgs> {
  ChatScreenRoute({_i25.Key? key, required _i28.ChatModel chatModel})
      : super(ChatScreenRoute.name,
            path: '/chat-screen',
            args: ChatScreenRouteArgs(key: key, chatModel: chatModel));

  static const String name = 'ChatScreenRoute';
}

class ChatScreenRouteArgs {
  const ChatScreenRouteArgs({this.key, required this.chatModel});

  final _i25.Key? key;

  final _i28.ChatModel chatModel;

  @override
  String toString() {
    return 'ChatScreenRouteArgs{key: $key, chatModel: $chatModel}';
  }
}
...
/// generated route for
/// [_i13.EmptyRouterPage]
class ChatsRouter extends _i13.PageRouteInfo<void> {
  const ChatsRouter({List<_i13.PageRouteInfo>? children})
      : super(ChatsRouter.name, path: 'chats', initialChildren: children);
...
class ChatsScreenRoute extends _i13.PageRouteInfo<void> {
  const ChatsScreenRoute() : super(ChatsScreenRoute.name, path: '');
...
class StoreScreenRoute extends _i13.PageRouteInfo<StoreScreenRouteArgs> {
  StoreScreenRoute(
      {_i25.Key? key,
      _i29.StoreScreenQualifier storeQualifer =
          _i29.StoreScreenQualifier.storeSettings})
...
class StoreScreenRouteArgs {
  const StoreScreenRouteArgs(
      {this.key, this.storeQualifer = _i29.StoreScreenQualifier.storeSettings});

  final _i25.Key? key;

  final _i29.StoreScreenQualifier storeQualifer;
