...
class SearchCard extends StatelessWidget {
  const SearchCard ({Key? key, required this.image, required this.name, required this.location, required this.desc, required this.onClose, required this.onTapInfo, required this.onTapLike}) : super(key: key);
