...
class ApplicationMainCardScreen extends StatelessWidget {
  const ApplicationMainCardScreen({Key? key, required this.applicant, required this.onClose})
      : super(key: key);
     ...
     BlurMask(
       ...
       child: Container(
           decoration: BoxDecoration(
             ...
             border:
                   Border.all(color: const Color.fromRGBO(251, 251, 251, 0.2), width: 2),
           ),
           ...
           child: Column(
             ...
             children: [
               ...
               Text(
                 '${applicant.name}, ${applicant.age} лет',
               ...
               Text(
                 '${applicant.location} - ${applicant.age} от вас',
                 style: const TextStyle(
               ...
               Row(
                 ...
                 crossAxisAlignment: CrossAxisAlignment.start,
                 children: [
                   _buildItemWidget(title: 'Семейное положение:',value: applicant.status),
                ...
                const SizedBox(height: 16),
                 _buildItemWidget(title: 'Наличие детей:',value: (applicant.havingChildren)?'Есть':'Нет'),
