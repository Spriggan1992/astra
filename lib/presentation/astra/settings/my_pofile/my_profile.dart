          ...
          return state.map(
              ...
              loadSuccess: (state) => BlocProvider(
                    ...
                    child:
                      ...
                      child: MyProfileScreenContent(profile: state.profile),
                    ),
                  ),
                  ...
                  children: [
                    ...
                    BlocBuilder<MyProfileActorBloc, MyProfileActorState>(
                      buildWhen: (p, c) =>
                          ...
                          p.profile.profilePhotos != c.profile.profilePhotos ||
                          p.selectedImages != c.selectedImages,
                      builder: (context, state) {
                        return ProfileLogoScreen(
                          images: state.profile.profilePhotos,
                          addedImgIrl: state.selectedImages.isNotEmpty
                              ? state.selectedImages.first.imagePath
                              : null,
                    ...
                    BlocBuilder<MyProfileActorBloc, MyProfileActorState>(
                      ...
                      builder: (context, shotrInfostate) {
                        return ProfileTextField(
                          ...
                          onChanged: (value) {
                            context.read<MyProfileActorBloc>().add(
                                MyProfileActorEvent.descriptionChanged(value));
                          },
                        );
                      },
                    ),
                    ...
                    BlocBuilder<MyProfileActorBloc, MyProfileActorState>(
                      builder: (context, state) {
                        return KuratorListTile(
                          leadingRadius: 22,
                          trallingRadius: 20,
                          name: state.curatorInfo.curatorFullname,
                          imageUrl: state.curatorInfo.profilePhoto,
                          onPressed: () {},
                        );
                      },
                    ),
