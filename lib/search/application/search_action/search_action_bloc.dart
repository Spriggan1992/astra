import 'package:astra_app/core/application/enums/search_action_type.dart';
import 'package:astra_app/core/domain/failure/astra_failure.dart';
import 'package:astra_app/search/domain/i_search_repository.dart';
...
class SearchActionBloc extends Bloc<SearchActionEvent, SearchActionState> {
  ...
  SearchActionState _getSearchEvent(
    Either<AstraFailure, Unit> response,
